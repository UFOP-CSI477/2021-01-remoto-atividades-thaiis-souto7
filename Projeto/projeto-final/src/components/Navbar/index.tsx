...
export function Navbar() {
  ...
  function handleMoveToSection(
    ...
    if (screenSize <= 900 && icon === true) { setIcon(false); }
  ...
  function SwitchMenuIcon() {
    if (screenSize <= 900) {
      if (icon === false) {
        return (
          <IoMenuOutline onClick={() => { setIcon(!icon); }} />
        );
      }
      return (
        <IoCloseOutline onClick={() => { setIcon(!icon); }} />
      );
    }
    ...
    return (
      <ul className="standart-menu">
        <li>
          <a href="Banner" onClick={(e) => { handleMoveToSection(e, document.getElementById('banner')?.offsetTop!); }}>Início</a>
        </li>
        <li>
          <a href="Services" onClick={(e) => { handleMoveToSection(e, document.getElementById('services')?.offsetTop!); }}>Serviços</a>
        </li>
        <li>
          <a href="AboutUs" onClick={(e) => { handleMoveToSection(e, document.getElementById('AboutUs')?.offsetTop!); }}>Sobre Nós</a>
        </li>
        <li>
          <a href="Partners" onClick={(e) => { handleMoveToSection(e, document.getElementById('Partners')?.offsetTop!); }}>Parceiros</a>
        </li>
        <li>
          <a href="contact" onClick={(e) => { handleMoveToSection(e, document.getElementById('contact')?.offsetTop!); }}>Contato</a>
        </li>
        <li>
          <a href="login" onClick={(e) => { handleMoveToSection(e, document.getElementById('login')?.offsetTop!); }}>Entrar</a>
        </li>
      </ul>
    );
  }
  ...
  useEffect(() => {
    ...
    if (icon === true) {
      ...
      setTimeout(() => { menuLine[0].classList.add('active'); }, 100);
  ...
  window.onresize = () => {
    ...
    if (screenSize > 900) { setIcon(false); }
  };
  ...
  window.onscroll = () => {
    ...
    if (currentScrollPosition >= document.getElementById('banner')!.offsetTop && currentScrollPosition < document.getElementById('services')?.offsetTop!) {
      menuOptions[0].classList.add('link-active');
    } else if (currentScrollPosition >= document.getElementById('services')!.offsetTop && currentScrollPosition < document.getElementById('AboutUs')?.offsetTop!) {
      menuOptions[1].classList.add('link-active');
    } else if (currentScrollPosition >= document.getElementById('AboutUs')!.offsetTop && currentScrollPosition < document.getElementById('Partners')?.offsetTop!) {
      menuOptions[2].classList.add('link-active');
    } else if (currentScrollPosition >= document.getElementById('Partners')!.offsetTop && currentScrollPosition < document.getElementById('contact')?.offsetTop!) {
      menuOptions[3].classList.add('link-active');
    } else if (currentScrollPosition >= document.getElementById('contact')!.offsetTop) {
  ...
  return (
    <Container id="navbar">
      <ContainerLogo>
        <a href="banner" onClick={(e) => { handleMoveToSection(e, 0); }}>
