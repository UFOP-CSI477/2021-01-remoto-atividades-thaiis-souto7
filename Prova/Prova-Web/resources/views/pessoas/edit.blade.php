					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" form action="{{ route('pessoas.update', $pessoa->id)}}" method="post">
									@csrf
									@method('PUT')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="bairro" name="bairro" required="required"
													class="form-control" value="{{ $pessoa->bairro }}">
											</div>
										</div>
										<div class="item form-group">
											<label for="cidade"
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="cidade" class="form-control" type="text"
													name="cidade" value="{{ $pessoa->cidade }}">
											</div>
										</div>
										<div class="item form-group">
											<label for="estado"
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="estado" class="form-control" type="text"
													name="estado" value="{{ $pessoa->estado }}">
											</div>
										</div>
										<div class="item form-group">
											<label for="cpf"
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{ $pessoa->dat_nasc }}" id="birthday" class="date-picker form-control"
