...
<html lang="pt-br">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
	  <link rel="icon" href="../images/icone.png" type="image/ico" />
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/" class="site_title">&nbsp;&nbsp;&nbsp;<i class="fa fa-medkit"></i> <span>&nbsp;&nbsp;COVID-19</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/geral">Dashboard</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Cadastros <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('pessoas.create')}}">Pessoas</a></li>
                      <li><a href="{{route('registros.create')}}">Registros</a></li>
                      <li><a href="{{route('unidades.create')}}">Unidades</a></li>
                      <li><a href="{{route('vacinas.create')}}">Vacinas</a></li>
                    </ul>
                  </li>
